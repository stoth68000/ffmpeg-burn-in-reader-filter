 ...
 *  ffmpeg -y -i ../../LTN/20170329/cleanbars-and-counter.ts -vf klburn=300:4096 -f mpegts new.ts
 */
...
static const AVOption klburn_options[] = {
...
static const AVFilterPad avfilter_vf_klburn_inputs[] = {
    {
        .name         = "default",
...
static const AVFilterPad avfilter_vf_klburn_outputs[] = {
    {
        .name = "default",
        .type = AVMEDIA_TYPE_VIDEO,
    },
